...
client.on("guildMemberAdd", member => {
  member.roles.add('781199821889339402'); // UNREGİSTER ROLÜNÜN İDSİNİ GİRİN
});
...
client.on("guildMemberAdd", member => {  
    ...
    const register = "<781214971434500136>"
